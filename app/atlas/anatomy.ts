...
export interface SceneState {regionParts?:string[];surfaceOpacity?:number;zoom?:number;inspectorOpen?:boolean;explode:number;visible:SystemId[];selected:string[];isolate:boolean;view:View;rotate:boolean;reset:number}
